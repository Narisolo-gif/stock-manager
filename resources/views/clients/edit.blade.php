{{--
    Vue : clients/edit.blade.php
    Rôle : Formulaire de modification d'un client existant
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-white border-bottom py-3 px-4 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-semibold text-dark">
                        <i class="bi bi-pencil-square me-2 text-warning"></i>Modifier le client
                    </h5>
                    {{-- Métadonnée : date de dernière mise à jour --}}
                    <span class="text-muted small">
                        Mis à jour {{ $client->updated_at->diffForHumans() }}
                    </span>
                </div>
