                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-uppercase small fw-semibold text-muted">Prénom</th>
                                <th class="text-uppercase small fw-semibold text-muted">Nom</th>
                                <th class="text-uppercase small fw-semibold text-muted">Email</th>
                                <th class="text-uppercase small fw-semibold text-muted">Téléphone</th>
                        ...
                        <tbody>
                            @foreach ($clients as $client)
                                <tr>
                                    ...
                                    {{-- Prénom --}}
                                    <td>
                                        <span class="fw-semibold text-dark">{{ $client->first_name }}</span>
                                    </td>

                                    {{-- Nom --}}
                                    <td>
                                        <span class="fw-semibold text-dark">{{ $client->last_name }}</span>
                                    </td>
                                    ...
                                    {{-- Téléphone (avec lien tel si présent) --}}
                                    <td>
                                        @if ($client->phone)
